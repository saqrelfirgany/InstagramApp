...
class StoryAdapter(private val mContext: Context, private val mStory: List<Story>) :
    ...
    override fun getItemCount(): Int = mStory.size
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        //Add Story
        var storyPlusBtn: CircleImageView? = itemView.story_add
        var addStoryText: TextView? = itemView.add_story_text
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                for (snapshot in p0.children) {
                    if (!snapshot.child("views")
                            ...
                            .exists() && System.currentTimeMillis() < snapshot.getValue(Story::class.java)!!.timeend
                    ) {
                        i++
                    }
                }
